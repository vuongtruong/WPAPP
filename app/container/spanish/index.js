...
class SpanishContainer extends Component{
    constructor(props) {
        super(props);
    ...
    initFirstLoading() {
        this.loading = true;
        axios.get(getUrl('spanish/videos'), {
            params: {
    ...
    async processLoadMore() {
        ...
        this.loading = true;
        await axios.get(getUrl('spanish/videos'), {
            params: {
                page: nextPage,
                ...DEFAULT_PARAMS,
                search: this.props.search,
    ...
    onOpenActionSheet(id, index) {console.log('onOpenActionSheet', Date.now());
...
export default connect(mapStateToProps, mapDispatchToProps)(SpanishContainer);