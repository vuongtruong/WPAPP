                ...
                props.show_loading ? (<ActivityIndicator size="large" color="#214158" style={{marginTop: 5}} />) : (
                    <View style={styles.main_container}>
                        ...
                        <View style={{height: 20, marginBottom: 10}}>
                            <Text style={{flex: 1, textAlignVertical: 'center', color: "#214158", fontWeight: '700', fontSize: 16}}>{props.video.speaker}</Text>
                        </View>
                        ...
                        <View style={styles.tab_wrapper}>
                            <View style={styles.flex_row}>
                                <Touchable underlayColor="#214158" style={props.current_tab == 'INFO' ? styles.tab_active : styles.tab_inactive} onPress={() => {props.setActiveTab('INFO');history.replace('/spanish/detail/' + props.video.id)}}><Text style={styles.tab_title}>Info</Text></Touchable>
                                <Touchable underlayColor="#214158" style={props.current_tab == 'COMMENT' ? styles.tab_active : styles.tab_inactive} onPress={() => {props.setActiveTab('COMMENT');history.replace('/spanish/detail/' + props.video.id + '/comment')}}><Text style={styles.tab_title_inactive}>Comments</Text></Touchable>
                            </View>
                        </View>
                        <Route exact path="/spanish/detail/:id" component={() => (
                        ...
                        <Route path="/spanish/detail/:id/comment" component={Comment}/>
                    </View>
                )
            }
        </ScrollView>
