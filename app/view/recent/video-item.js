...
export const VideoItem = (props) => (
    <Link to={'/detail/' + props.id} onLongPress={()=>{props.onOpenActionSheet(props.id, props.index)}} delayLongPress={200}>
        <View>
            <View style={styles.video_item}>
                <View style={styles.flex_row}>
                    ...
                    <View style={styles.video_brief_detail}>
                        <Text style={styles.video_title}>{props.title}</Text>
...
const styles = StyleSheet.create({
    ...
    video_title: {fontSize: 16, lineHeight: 18, fontWeight: '900', height: 40, color: '#214158', paddingRight: 20, paddingTop: 2},
