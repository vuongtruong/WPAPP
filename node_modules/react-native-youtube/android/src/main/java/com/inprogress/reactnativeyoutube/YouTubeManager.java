...
public class YouTubeManager extends SimpleViewManager<YouTubeView> {
    ...
    private static final int COMMAND_SET_PLAY = 5;
    private static final int COMMAND_SET_CONTROLS = 6;
    ...
    public Map<String,Integer> getCommandsMap() {
        return MapBuilder.of(
            ...
            COMMAND_PLAY_VIDEO_AT,
                "setPlay", COMMAND_SET_PLAY,
                "setControls", COMMAND_SET_CONTROLS
        );
    }
    ...
    public void receiveCommand(YouTubeView view, int commandType, @Nullable ReadableArray args) {
        ...
        switch (commandType) {
            ...
            case COMMAND_SET_PLAY: {
                view.setPlay(args.getBoolean(0));
                return;
            }
            case COMMAND_SET_CONTROLS: {
